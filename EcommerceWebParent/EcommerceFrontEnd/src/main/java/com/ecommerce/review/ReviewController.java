...
import com.ecommerce.product.ProductNotFoundException;
...
public class ReviewController {
    ...
    public String listByProductByPage(Model model,
        ...
        Customer customer = controllerHelper.getAuthenticatedCustomer(request);
        if (customer != null) {
            voteService.markReviewVotedForProductByCustomer(listReviews, product.getId(), customer.getId());
        }
