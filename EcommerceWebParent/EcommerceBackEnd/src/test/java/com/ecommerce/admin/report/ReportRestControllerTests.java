...
public class ReportRestControllerTests {
    ...
    public void testGetReportDataLast7Days() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(requestURL)).andExpect(MockMvcResultMatchers.status().isOk())
    ...
    @Test
    @WithMockUser(username = "user1", password = "pass1", authorities = {"Salesperson"})
    public void testGetRepositoryDataByCategory() throws Exception {
    ...
    @Test
    @WithMockUser(username = "user1", password = "pass1", authorities = {"Salesperson"})
    public void testGetRepositoryDataByProduct() throws Exception {
