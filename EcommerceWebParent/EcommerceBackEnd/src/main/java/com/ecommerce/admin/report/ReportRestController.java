...
public class ReportRestController {
    ...
    public List<ReportItem> getReportDataByCategoryOrProductDateRange(@PathVariable String startDate, @PathVariable String endDate, @PathVariable String groupBy) throws ParseException {
